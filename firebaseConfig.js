...
import { getDatabase, ref, set, onValue, push, update } from "firebase/database"; // Add update here
...
export { database, ref, set, onValue, push, update, storage }; // Export update here
